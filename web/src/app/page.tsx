...
import { cloudDoctorState, cloudPipelineSummary } from "@/lib/cloud-career-ops";
...
export default async function Home() {
  const { phase, onboardingNeeded } = cloudDataEnabled() ? await cloudDoctorState() : doctorState();
